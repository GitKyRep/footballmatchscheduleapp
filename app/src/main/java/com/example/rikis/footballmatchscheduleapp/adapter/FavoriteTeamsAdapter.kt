...
class FavoriteTeamsAdapter(private val favorite: List<FavoritesTeam>, private val listener: (FavoritesTeam) -> Unit)
...
class FavoriteViewHolder(view: View) : RecyclerView.ViewHolder(view) {
    ...
    fun bindItem(favorite: FavoritesTeam, listener: (FavoritesTeam) -> Unit) {
