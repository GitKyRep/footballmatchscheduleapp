...
class SpinnerAdapter(val context: Context, var listItemsTxt: List<League>) : BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        vh.label.text = listItemsTxt.get(position).strLeague
        return view
    }
    ...
    private class ItemRowHolder(row: View?) {
        val label: TextView
        init {
            this.label = row?.findViewById(R.id.txtLeagueName) as TextView
        }
    }
}